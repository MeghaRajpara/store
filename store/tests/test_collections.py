...
class TestCreateCollections:
    ...
    def test_if_user_is_admin_returns_403(self, authenticate, api_client, create_collection):
        authenticate()
...
class TestRetrieveCollection:
    ...
    def test_if_collection_not_exists_returns_200(self, api_client):

        response = api_client.get('/store/collections/26/')
